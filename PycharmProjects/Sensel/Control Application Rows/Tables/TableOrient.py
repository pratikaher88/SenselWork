    ...
    if frame.n_contacts > 0:
        ...
        for n in range(frame.n_contacts):
            ...
            if len(contacts_list) == frame.n_contacts:
                ...
                if c.total_force>1500:
                    print("New cell list on high force", new_cell_list)
                    print(cols)
                    # print(new_cell_list[0])

                    for i in reversed(range(new_cell_list[0][1],2)):
                        print("Color These",new_cell_list[0][0],i)
                        selected_cell_list.append((new_cell_list[0][0],i))
                        col = the_table.get_celld()[new_cell_list[0][0],i]
                        col.set_facecolor('blue')

                if c.total_force>2000:
                    print("New cell list on high force", new_cell_list)
                    print(cols)
                    # print(new_cell_list[0])

                    for i in reversed(range(new_cell_list[0][1],1)):
                        print("Color These",new_cell_list[0][0],i)
                        selected_cell_list.append((new_cell_list[0][0],i))
                        col = the_table.get_celld()[new_cell_list[0][0],i]
                        col.set_facecolor('blue')

                if c.total_force>2500:
                    print("New cell list on high force", new_cell_list)
                    print(cols)
                    # print(new_cell_list[0])

                    for i in reversed(range(new_cell_list[0][1],0)):
                        print("Color These",new_cell_list[0][0],i)
                        selected_cell_list.append((new_cell_list[0][0],i))
                        col = the_table.get_celld()[new_cell_list[0][0],i]
                        col.set_facecolor('blue')
