...
textstr='Not Selected'

ax.text(100, 140, textstr, fontsize=14)
colLabels = ("Structure", "Energy", "Density", "Density", "Density", "Density","Structure", "Energy", "Density", "Density", "Density", "Density", "Density", "Density", "Density", "Density")
...
the_table = ax.table(colLabels=colLabels,cellText=clust_data,
