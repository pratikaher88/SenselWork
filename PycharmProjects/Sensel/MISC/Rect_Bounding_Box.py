...
def printFrame(frame, info):
    ...
    if frame.n_contacts > 0:
        ...
        for n in range(frame.n_contacts):
            ...
            # rect = Rectangle((c.max_x,c.max_y), 40, 30, linewidth=1, edgecolor='r', facecolor='none')

            if (c.total_force < 100):
                rect = Rectangle((c.x_pos, c.y_pos),c.min_x,c.min_y, linewidth=1, edgecolor='r', facecolor='none')
