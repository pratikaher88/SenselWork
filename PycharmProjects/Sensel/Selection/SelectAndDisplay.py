            ...
            if len(contacts_list) == frame.n_contacts:
                ...
                try:
                    if c.total_force>1000:
                            print("BLOCK")
                            print(new_cell_list[0][0],new_cell_list[0][1])
                            print(new_cell_list[1][0],new_cell_list[1][1])
                ...
                ax.text(60, 140, "Selected Values", fontsize=14)

                ax.text(100, 140, str(selected_data_values), fontsize=14)
